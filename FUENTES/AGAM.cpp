...
vector<Cromosoma> InicializarPoblacion(vector< vector<double> > matrizParticion, vector< vector<string> > target, int test, int tam, int numCaracteristicas, int semilla){
    ...
    for(int i=0; i<tam; i++){
        ...
        poblacion.push_back(Cromosoma(Wprima,funcionEvaluacion(matrizParticion, target, test, tam, numCaracteristicas, Wprima, false)));
    }
...
void ModeloGeneracional(int opcion, vector< vector<double> > matrizParticion, vector< vector<string> > target, int test, int tam, int numCaracteristicas, int semilla, int memetico = 0){ 
    ...
    poblacion = InicializarPoblacion(matrizParticion,target,test,tamPoblacion,numCaracteristicas,semilla);
